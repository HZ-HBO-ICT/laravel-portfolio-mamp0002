...
<head>
    <title>Blogpost studychoice</title>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.5">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <meta name="description" content="A blogpost about why I chose this Study
    Programme and why ICT interests me.">
    <link type="text/css" rel="stylesheet" href="/css/style-website.css">
</head>

<body>
<header><a href="https://www.hz.nl" target="_blank"><img alt="HZ-logo" src="/img/hzlogo.png" class="hzlogo"></a>Study Choice
</header>
<nav>
    <ul>
