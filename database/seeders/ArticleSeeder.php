...
class ArticleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('articles')->insert([
            ...
            'body'=>'<p>Last Friday, we had a company Safari. In the morning, we attended two presentations of IT
                    companies, and in the afternoon we looked online at some other IT companies. From those, I chose
                    three companies that interested me the most. In this blogpost, you will read what the companies
                    do and what my pros and cons are. You can click on the posters, to be able
                    to read them better.</p>
                <br><br>
            </article>
        </section>
        <section class="grid-blogpostprof">
            <article><a href="/img/PosterSAP.png" target="_blank"><img alt="Poster with information about SAP"
                src="/img/PosterSAP.png"
            ...
            <article class="item-2-and-8">
                ...
                <p>SAP is one of the worlds leading producers of software for the management of business processes,
                    developing solutions that facilitate effective data processing and information flow across
                    organizations. They are headquartered in Walldorf, Germany, with more than 101,000 employees spread
                    out over more than 78 countries.
                </p>
    ...
    interest. So especially for someone that is just entering the corporate world, it is good to have the
            ...
            <article></article>
            <article></article>
            <article class="item5"><a href="/img/PosterSyntess.png" target="_blank"><img alt="Poster with
            information about Syntess"
                        src="/img/PosterSyntess.png" class="poster"></a></article>
            <article class="item6">
                ...
                <p>
                    ...
                    big opportunities as at a bigger company as to finding out what you like and trying different
                    things. Overall, I do think a smaller company fits me better.
                </p>
            </article>
            ...
            <article class="item-2-and-8">
                ...
                <p>
                    ...
                    and accommodation rental sector. Originally a DUtch company, since its formation in 1998, Maxxton
                    has grown into a multinational organization with operations in three continents and clients spread
                    across the globe.<br>
                    Maxxton has developed and perfected a holistic ERP approach to technology in hospitality and tourism
                    and a suite of solutions to suit the needs of most complex organizations. This means that they
                    deliver efficient solutions, adapted to the needs of each specific client, which means that they are
                    very flexible in the delivery of their technology and fully adapt it according to requirements.
                    Their developments and continuos updates are driven by the in-depth knowledge of our market and our
                    clients, with which we work as true partners and which are both beneficiaries
                    and initiators of our continuous software enhancement.
                </p>
                <h3>Why would I like to work at Maxxton in the future?</h3>
                <p>
                What attracts me the most to Maxxton, is the fact that they adapt their software for each costumor. So
                every time there is a new customer, they will look at what they want and what is possible. To try and
                meet their needs as much as possible, sounds like a really fun and challenging job. Also the fact that
                they keep developing and updating the software, so you have to try
                ...
                But it feels like the culture is not going to change, it keeps the smaller company culture, even if it
                grows a lot.
                </p>
        ...
        DB::table('articles')->insert([
            ...
            'body'=>'<p>I received some points of feedback on my Who-Am-I document. The first point was that I really
                        have to explore and find out what my inner drive is for this study programme and ICT in general.
                        With just `I like programming, I think it is fun` you are probably not going to get far,
                        because eventually you will come across a programming language that you really hate. I have
                        thought about this part of the feedback and I have added some things to the blogpost about my
                        study choice. I think I have found what drives me.<br><br>
                        The second point was about the SWOT Analysis. I want everything to be perfect and that gives me
                        stress. Also with this website, every day I am thinking `No it is not good enough, I have to
                        change everything`. The feedback was mostly `less is more`, with the following tips:
                <ul>
                    <li>Set an alarm when you are studying, for when you have to stop and go do something else.</li>
                    <li>In the evening, when a lot of things pop into your head about what you need to do, write them
                    down and leave them.</li>
                    <li>In the morning, begin with the one thing that has to be finished by the end of the day.</li>
                    <li>Spend one hour less on school than your fellow classmates, you need the time to evaluate
                    and recover from the day.</li>
                </ul>
        ...
        DB::table('articles')->insert([
            ...
            'body'=>'<p>I have some programming experience, this is mostly due to my hobbies and interests, but also
        ...
        DB::table('articles')->insert([
            ...
            'body'=>'<h4>By making a SWOT-analysis, you analyse your personal strengths and weaknesses and make an
                        inventory of the opportunities and threats you expect in your studies. </h4>
            </article>
            <article>
        ...
        DB::table('articles')->insert([
            ...
            'body'=>'                <h2>Why I chose ICT</h2>
                <p>For a long time, I didn&#8217t know what I wanted to do. I have tried a studies at Law school and a
                    Mathematics
                    studies. Both were not the right choice for me. After I quit the last studies, I took two years off
                    from school.
                    I worked for a year and I really wanted to make sure that I was going to make the right choice for
                    myself. My dad is the founder of a very successful ICT-company. I think deep down I always knew I
                    had a passion for ICT; when I was younger I wanted to go with him to work often, and I wanted to
                    &#x0022help&#x0022 in my spare time doing basic things for him.
                    So ICT was and is always connected to my dad. I think at first I didn&#8217t want to admit that
                    I had a passion for ICT, because I was afraid that people were going to think that I was just going
                    in the same route as my dad  and always compare me to him. But last year I realized that I found
                    ICT really fun, and I decided that I was going to follow that passion.
                    I want to prove to everyone and mostly myself, that I can be a good ICT-er as well. Even if my dad
                    was very successful and even if there are very few women in ICT.</p>
            </article>
            <article>
                <h2>Why I chose this study programme</h2>
                <p>At first I considered working at a firm where I could grow into being a software developer. But for
                    me it is better to learn the matter in a class and be more confident in the matter before I pursue
                    a career. I chose this study programme because it is very project-based with real companies with
                    real questions. I think it is good to learn in projects and by finding things out yourself. In that
                    way you can prepare better for a future career, where you will likely have to work in groups and
                    they don&#8217t spell everything out for you.
